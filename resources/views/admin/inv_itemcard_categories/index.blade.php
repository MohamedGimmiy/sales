    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{ route('inv_itemcard_categories.create') }}" class="btn btn-success btn-sm">اضافة فئة اصناف</a>
                    ...
                    <tbody>
                        @foreach ($data as $info)
                            ...
                            <td>
                                ...
                                <td>
                                    <a href="{{ route('inv_itemcard_categories.edit',$info->id) }}" class="btn btn-primary btn-sm">تعديل</a>
                                    <a onclick="return confirm('هل متأكد من حذف الفئة؟')" href="{{ route('inv_itemcard_categories.delete',$info->id) }}"class="btn btn-danger btn-sm">حذف</a>
                                </td>
                            </tr>
                        @endforeach
